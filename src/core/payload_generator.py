...
class PayloadGenerator:
    ...
    def generate(payload_type: str, size: int, message_id: int, scenario_id: str, run_number: int) -> str:
        ...
        if payload_type == "json":
            return PayloadGenerator._generate_json(size, message_id, scenario_id, run_number)

        return PayloadGenerator._generate_text(size, message_id, scenario_id, run_number)
    ...
    @staticmethod
    def _generate_json(size: int, message_id: int, scenario_id: str, run_number: int) -> str:
        base = {
